...
with h5py.File(trn_data, 'r') as hf:
    x = np.array(hf.get('Msol1s_diff_noisy')[:-1000])
...
params = {'L1': 1024, 'weight_decay': 0, 'alpha':1e-1, 'batch_size':25, 'trn_data':trn_data, 'notes':'using 2 layer fc network with noisy data'}
